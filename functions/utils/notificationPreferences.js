...
const normalizeGroupPreferences = value => {
  ...
  return {
    ...
    matchSignups: isBoolean(raw.matchSignups) ? raw.matchSignups : defaults.matchSignups,
    matchUnsignups: isBoolean(raw.matchUnsignups) ? raw.matchUnsignups : defaults.matchUnsignups,
    matchReady: isBoolean(raw.matchReady) ? raw.matchReady : defaults.matchReady,
